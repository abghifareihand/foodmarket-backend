                ...
                <form class="w-full" action="{{ route('food.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Bawang Merah, Bawang
                                Putih</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Recomended, Popular</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
